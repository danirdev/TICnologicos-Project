      ...
      <section className="py-20">
        <div className="px-4 mx-auto max-w-7xl">
          <div className="grid gap-8 md:grid-cols-3">
            {/* Who We Are */}
            <motion.div
              className="p-8 text-center transition-shadow bg-white shadow-xm dark:bg-gray-800 rounded-2xl hover:shadow-xl"
            ...
            {/* What We Do */}
            <motion.div
              className="p-8 text-center transition-shadow bg-white shadow-lg dark:bg-gray-800 rounded-2xl hover:shadow-xl"
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-6xl px-4 mx-auto">
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-6">
            {technologies.map((tech, index) => (
              <motion.div
                key={tech.name}
                className="p-6 text-center transition-all duration-300 bg-white shadow-lg dark:bg-gray-800 rounded-xl hover:shadow-xl"
